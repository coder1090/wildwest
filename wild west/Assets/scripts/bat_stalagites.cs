...
public class bat_stalagites : MonoBehaviour
{
    public GameObject[] animalPrefabs;
    public float spawnrangex = 0;
    public float spawnangex2 = 1;
    ...
    void SpawnRandomMonster()
    {
        ...
        Vector3 spawnPos = new Vector3(Random.Range(spawnrangex, spawnangex2), spawnrangeY, spawnposz);
